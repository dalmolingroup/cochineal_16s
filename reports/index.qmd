...
The full data for the calculated taxonomic abundance can be interacted with in the following page: <https://jvfe.github.io/cochineal_16s/qiime2_relative_abundance/>. It enables analysis at every taxonomic level, showing the relative frequency of each taxa at that level.
